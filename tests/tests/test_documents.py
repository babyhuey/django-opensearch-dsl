...
from django_opensearch_dsl.exceptions import (
...
class DocumentTestCase(TestCase):
    ...
    def test_queryset_pagination_added(self):
        ...
        self.assertEqual(
            CarDocument.django.queryset_pagination,
    ...
    def test_default_generate_id_is_called(self, _):
        ...
        with patch.object(
            ArticleDocument, "generate_id", return_value=article.id
        ) as patched_method:
            d = ArticleDocument()
    ...
    def test_index_settings_default_to_settings(self):
        ...
        self.assertEqual(
            ArticleDocument._index._settings, {"codec": "best_compression"}
        )
    ...
    def test_index_settings_use_index_settings_merge_global_settings(self):
        ...
        self.assertEqual(
            ArticleDocument._index._settings,
            {"codec": "best_compression", "hidden": True},
        )
    ...
    def test_index_settings_use_index_settings_override_global_settings(self):
        ...
        self.assertEqual(
            ArticleDocument._index._settings, {"codec": "default", "hidden": True}
        )
