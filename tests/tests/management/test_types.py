...
class TypeTestCase(TestCase):
    ...
    def test_datetime_parser(self):
        self.assertEqual(
            ...
            types.datetime_parser("2020-08-20"),
        )
        self.assertEqual(
            datetime.datetime(2020, 8, 1, 0, 0, tzinfo=datetime.timezone.utc),
            types.datetime_parser("2020-08"),
        )
        self.assertEqual(
            datetime.datetime(2020, 1, 1, 0, 0, tzinfo=datetime.timezone.utc),
            types.datetime_parser("2020"),
        )
        self.assertEqual(
            datetime.datetime(
                2020,
        ...
        self.assertEqual(
            datetime.datetime(2020, 8, 20, 0, 0, tzinfo=datetime.timezone.utc),
            types.datetime_parser("2020-W34-4"),
        )
        self.assertEqual(
            datetime.datetime(2020, 8, 20, 0, 0, tzinfo=datetime.timezone.utc),
            types.datetime_parser("2020-233"),
        )
