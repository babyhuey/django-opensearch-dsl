...
class DocumentTestCase(TestCase):
    ...
    def test_index_all(self):
        ...
        call_command(
            "opensearch", "document", "index", verbosity=0, force=True, refresh=True
        )
        ...
        self.assertEqual(
            EventDocument.search().count(),
            Event.objects.exclude(country__name="France").count(),
        )
    ...
    def test_index_filters_gte(self):
        ...
        self.assertEqual(
            CountryDocument.search().count(),
            Country.objects.select_related("continent")
            .filter(population__gte=1000000)
            .count(),
        )
        self.assertEqual(ContinentDocument.search().count(), 0)
        self.assertEqual(EventDocument.search().count(), 0)
    ...
    def test_index_excludes_gte(self):
        ...
        self.assertEqual(
            CountryDocument.search().count(),
            Country.objects.select_related("continent")
            .exclude(population__gte=1000000)
            .count(),
        )
        self.assertEqual(ContinentDocument.search().count(), 0)
        self.assertEqual(EventDocument.search().count(), 0)
    ...
    def test_index_not_refresh(self):
        ...
        self.assertEqual(EventDocument.search().count(), 0)
        call_command(
            "opensearch", "document", "index", verbosity=0, force=True, count=3
        )
        self.assertEqual(ContinentDocument.search().count(), 0)
        self.assertEqual(CountryDocument.search().count(), 0)
        self.assertEqual(EventDocument.search().count(), 0)
